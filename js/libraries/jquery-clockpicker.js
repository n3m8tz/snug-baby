	...
	function ClockPicker(element, options) {
		...
		if (options.twelvehour) {
			...
			var  amPmButtonsTemplate = ['<div class="clockpicker-am-pm-block">',
				'<a href="javascript:void(0)" class="waves-effect btn-default clockpicker-button clockpicker-am-button">',
				'AM</a>',
				'<a href="javascript:void(0)" class="waves-effect btn-default clockpicker-button clockpicker-pm-button">',
				'PM</a>',
				'</div>'].join('');
			...
			$('<a href="javascript:void(0)" class="waves-effect  btn-default clockpicker-button am-button">' + "AM" + '</a>')
				.on("click", function() {
					self.amOrPm = " AM";
					$('.clockpicker-span-am-pm').empty().append(' AM');
			...
			$('<a href="javascript:void(0)" class="waves-effect  btn-default clockpicker-button pm-button">' + "PM" + '</a>')
				.on("click", function() {
					self.amOrPm = ' PM';
					$('.clockpicker-span-am-pm').empty().append(' PM');
				}).appendTo(this.amPmBlock);
